...
if __name__ == "__main__":
    agents = [
        {"name": "agent1", "botclass": Group58Agent, "settings": {"color": "#0000FF", "shape": 1, "colourblind": True}},
        {"name": "agent2", "botclass": Group58Agent, "settings": {"color": "#000000", "shape": 2, "colourblind": False}},
